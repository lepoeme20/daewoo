...
def main():
    ...
    output_image = match_histograms(image_src, image_ref2)
 
    img = cv2.imread('E:/crop/20200510120104_34.jpg', cv2.IMREAD_GRAYSCALE)
    plt.imshow(image_src[:,:,0],cmap='gray')
    plt.imshow(img,cmap='gray')

    plt.imshow(image_src)
    plt.imshow(image_ref)
    plt.imshow(image_ref2)
