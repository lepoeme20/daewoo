...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--dataset", type=str, default='weather_4',
        help="csv file path"
    )
    parser.add_argument(
        "--norm-type", type=int, default=0 ,  choices=[0, 1, 2],
    ...
    parser.add_argument(
        ...
        # E:\daewoo\dataset\weather\data_crop
    ...
    parser.add_argument(
        "--label-type", type=int, default=0, choices=[0, 1, 2],
